...
sol = solve(prob, Rodas5(), reltol = ode_reltol, abstol = ode_abstol, saveat = 0.1) #Rodas5 #FBDF
...
function scaler_fun_of_interest(u)
    ...
    sol = solve(_prob, Rodas5(autodiff=false), reltol = ode_reltol, abstol = ode_abstol, maxiters=ode_maxiters) #Rodas5 #FBDF
